...
def get_data(data_manager, ids: list):
    ...
    train_single_X, train_single_y = train_single[:, [1, 2]], train_single[:, [3]]
    val_single_X, val_single_y = val_single[:, [1, 2]], val_single[:, [3]]
...
if __name__ == '__main__':
    ...
    CFG_FILE = '../cfgs/default_2.yml'
    SAVE_DIR = './results'
    task_info = get_args(CFG_FILE)
    Data_manager = DataSet_2(paths=task_info['DATA_PATH'], year_split=True)
    result_dict = {}
