from base_src import MLP_dataset, MLP_dataset_emb, MLP_dataset_emb_cluster_3
...
MATCHES_PATH = '/home/mateusz/Desktop/Demand-Forecast/baseline/results_mlp/transfer/emb_assignments_3.pkl'
...
for group in model_groups:
    ...
    for num in model_nums:
        try:
            ...
            train_data = MLP_dataset_emb_cluster_3(path=DATA_PATH, train=True, lag=LAG, get_quant=QUANT, normalize=NORMALIZE,
                                             embedders=embedders, matches=matches)
            val_data = MLP_dataset_emb_cluster_3(path=DATA_PATH, train=False, lag=LAG, get_quant=QUANT, normalize=NORMALIZE,
                                           embedders=embedders, matches=matches)
...
pickle.dump(out_dict, open(f'{OUT_PATH}/clustering_out_3.pkl', 'wb'))
