...
args_dir = '/Users/nuwan.gunasekara/Desktop/CODE/Demand-Forecast/DS/NZ_energy_latest_LAG_0'
with open(os.path.join(args_dir, 'results_half.pkl'), 'rb') as f:
    results1 = pickle.load(f)

args_dir = '/Users/nuwan.gunasekara/Desktop/CODE/Demand-Forecast/DS/NZ_energy_latest_LAG_0_1'
