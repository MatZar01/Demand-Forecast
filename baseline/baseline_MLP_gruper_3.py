...
for i in range(MAX_MODELS):
    ...
    while True:
        ...
        # set trainer
        light_model = L_Net(model=model, loss_fn=loss, test_fn=loss, optimizer=optimizer, out_path=OUT_PATH,
...
pickle.dump(out_dict, open(f'{OUT_PATH}/model_out_grouper_3.pkl', 'wb'))
