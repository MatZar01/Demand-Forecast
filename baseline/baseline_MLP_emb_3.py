from base_src import MLP_dataset_emb_3
...
for m in matches:
    try:
        train_data = MLP_dataset_emb_3(path=DATA_PATH, train=True, lag=LAG, get_quant=QUANT, normalize=NORMALIZE,
                                     embedders=embedders, matches=m)
        val_data = MLP_dataset_emb_3(path=DATA_PATH, train=False, lag=LAG, get_quant=QUANT, normalize=NORMALIZE,
                                   embedders=embedders, matches=m)
